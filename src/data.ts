...
export const gifs: GifItem[] = [
  ...
  { id: '6', name: 'Breath', path: 'gifs/6-grand spread.gif' },
  { id: '7', name: 'Heartbeat', path: 'gifs/7-heartbeat.gif' },
  { id: '8', name: 'Crush', path: 'gifs/8-crush.gif' },
];

export const musicTracks: MusicTrack[] = [
  { id: '1', name: 'Track 005', path: 'music/005_1.wav' },
  { id: '2', name: 'Track 025', path: 'music/025_1.wav' },
  { id: '3', name: 'Track 025 Alt', path: 'music/025_1 [1].wav' },
  { id: '4', name: 'Track 068', path: 'music/068_1.wav' },
];